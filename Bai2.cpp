...
int main() {
	...
	while (1) {
		...
		if (!isLoggedIn) {
			...
			FILE* f = fopen("C:\\Users\\Lenovo\\source\\repos\\BVN_Bai2\\csdl.txt", "r");
			...
			strcat(buf, " > C:\\Users\\Lenovo\\source\\repos\\BVN_Bai2\\out.txt");
			...
			send(client, "C:\\Users\\Lenovo\\source\\repos\\BVN_Bai2\\out.txt\n", 47, 0);
		}
